...
class O18_MaxSubArraySumTest {
    ...
    public void shouldReturnMaxSubArraySum() {
        ...
        int actual = maxSubArraySum.maxSubArraySum(new int[]{2, 3, -8, 7, -1, 2, 3});
        Assertions.assertEquals(11, actual);
        actual = maxSubArraySum.maxSubArraySum(new int[]{5, 8, 3});
        Assertions.assertEquals(16, actual);
        actual = maxSubArraySum.maxSubArraySum(new int[]{1, 1, 3, -5, 3, -2, 2, 1});
